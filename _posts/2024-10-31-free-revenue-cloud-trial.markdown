...
<a href="https://www.salesforce.com/form/signup/comms-cloud-learning-trial/" target="_blank" class="button button--primary">
    Start Free Trial
</a>
...
**OR**
Install <a href="https://silkquote.com" style="color: blue; text-decoration: underline;">SilkQuote</a> 
a free AppExchange app built to replace the limited native document generation for Revenue Cloud.

1. Visit **[silkquote.com](https://silkquote.com)** and click **Install** to open the AppExchange listing
2. Select **Install for Admins Only** and complete the installation
3. Follow the setup guide at **[silkquote.com/install](https://silkquote.com/install)** to configure templates and permissions
